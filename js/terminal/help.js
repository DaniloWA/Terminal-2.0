...
export function help(){
    ...
    if(rgHelpList().exec(dados)) 
        return 'Lista de comandos ' + '<br>' + 'Help Analisar' + '<br>' + 'Help Calculadora' + '<br>' + 'Help Embaralhar' + '<br>' + 'Help Destino' + '<br>' + 'Help Email' + '<br>' + 'Help Nomes' + '<br>' + 'Help numeros' + '<br>' + 'Help senha' + '<br>' + 'Help inverter'
    ...
    if(regexHelp().exec(dados))
        return 'Bem vindo ao Help!' + '<br>' + 'Digite "Help list"'
